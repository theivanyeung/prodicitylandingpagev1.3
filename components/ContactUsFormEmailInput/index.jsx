...
function ContactUsFormEmailInput(props) {
  const { inputType, inputPlaceholder, className } = props;

  return (
    <ContactUsFormEmailInput1 className={`contact-us-form-email-input ${className || ""}`}>
      <EmailInputPlaceholderText
        className="email-input-placeholder-text-1"
        name="emailinputplaceholdertext"
        placeholder={inputPlaceholder}
        type={inputType}
      />
    </ContactUsFormEmailInput1>
  );
}

const ContactUsFormEmailInput1 = styled.div`
  width: 287px;
  height: 46px;
  margin-top: 11px;
  display: flex;
  ...
  &.contact-us-form-email-input.contact-us-form-subject-input {
    height: 44px;
    margin-top: 10px;
  }
`;
...
export default ContactUsFormEmailInput;
