...
import ContactUsFormEmailInput2 from "../ContactUsFormEmailInput2";
...
import "./LandingPageXSV22.css";

function LandingPageXSV22(props) {
  const {
    introduction,
    about,
    gamification,
    ...
    topOfPageIcon,
    gamilificationImageProps,
    contactUsFormEmailInput21Props,
    contactUsFormEmailInput22Props,
    contactUsFooterProps,
  } = props;

  return (
    <form className="landing-page-xs-v2-2 screen" name="form5" action="form5" method="post">
      <Introduction style={{ backgroundImage: `url(${introduction})` }} id="introduction">
        ...
        <Waitlist>
          <Rocket className="animate-enter39" src={rocket} />
          <WaitlistTextGroup className="animate-enter38">
      ...
      <AboutUs id="about-us">
        <AboutUsMain className="animate-enter37" show-on-scroll>
          <AboutUsTop>
            <AboutUsTopLeft>
      ...
      <Gamilification id="gamilification">
        <GamificationHeader className="animate-enter36">
        ...
        <GamilificationImage className={gamilificationImageProps.className} />
      </Gamilification>
      <Productivity1 id="productivity">
        <GroupSessions>
          <GroupSessionsImage className="animate-enter31" show-on-scroll src={groupSessionsImage} />
          <GroupSessionsTextGroup className="animate-enter30" show-on-scroll>
        ...
        <Marketplace>
          <MarketplaceImage className="animate-enter33" show-on-scroll src={marketplaceImage} />
          <MarketplaceTextGroup className="animate-enter32" show-on-scroll>
      ...
      <Differentiation>
        <DifferentContainer>
          ...
          <DifferentiationHeader className="animate-enter29" show-on-scroll>
      ...
      <ContactUs id="contact-us">
        <ContactUsContainer>
          <ContactUsMain>
            <ContactUsLeft>
              <ContactUsForm>
                <ContactUsFormEmail>
                  ...
                  <ContactUsFormEmailInput2
                    inputType={contactUsFormEmailInput21Props.inputType}
                    inputPlaceholder={contactUsFormEmailInput21Props.inputPlaceholder}
                  />
                </ContactUsFormEmail>
                <ContactUsFormSubject>
                  <ContactUsFormSubjectLabel src={contactUsFormSubjectLabel} />
                  <ContactUsFormEmailInput2
                    inputType={contactUsFormEmailInput22Props.inputType}
                    inputPlaceholder={contactUsFormEmailInput22Props.inputPlaceholder}
                    className={contactUsFormEmailInput22Props.className}
                  />
                </ContactUsFormSubject>
            ...
            <ContactUsRight className="animate-enter27">
          ...
          <ContactUsHeader className="animate-enter28" show-on-scroll>
        ...
        <ContactUsFooter className={contactUsFooterProps.className} />
      </ContactUs>
    </form>
  );
}
...
const Rocket = styled.img`
  ...
  &.animate-enter39 {
    display: block;
    animation: animate-enter39-frames 0.4s ease-in-out 0.2s 1 normal forwards;
    opacity: 0;
    transform: scale(1.1);
  }
...
const WaitlistTextGroup = styled.div`
  ...
  &.animate-enter38 {
    animation: animate-enter38-frames 0.2s ease-in-out 0s 1 normal forwards;
    opacity: 0;
  }
`;
...
const AboutUsMain = styled.div`
  ...
  &.animate-enter37 {
    animation: animate-enter37-frames 0.4s ease-in-out 0s 1 normal forwards;
    opacity: 0;
    transform: translate(-25px, 0);
  }
`;
...
const GamificationHeader = styled.div`
  ...
  &.animate-enter36 {
    animation: animate-enter36-frames 0.4s ease-in-out 0s 1 normal forwards;
    opacity: 0;
  }
`;
...
const GroupSessionsImage = styled.img`
  ...
  &.animate-enter31 {
    display: block;
    animation: animate-enter31-frames 0.4s ease-in-out 0s 1 normal forwards;
    opacity: 0;
    transform: translate(-25px, 0);
  }
...
const GroupSessionsTextGroup = styled.div`
  ...
  &.animate-enter30 {
    animation: animate-enter30-frames 0.4s ease-in-out 0s 1 normal forwards;
    opacity: 0;
    transform: translate(25px, 0);
  }
`;
...
const MarketplaceImage = styled.img`
  ...
  &.animate-enter33 {
    display: block;
    animation: animate-enter33-frames 0.4s ease-in-out 0s 1 normal forwards;
    opacity: 0;
    transform: translate(25px, 0);
  }
...
const MarketplaceTextGroup = styled.div`
  ...
  &.animate-enter32 {
    animation: animate-enter32-frames 0.4s ease-in-out 0s 1 normal forwards;
    opacity: 0;
    transform: translate(-25px, 0);
  }
`;
...
const DifferentiationHeader = styled.div`
  ...
  &.animate-enter29 {
    animation: animate-enter29-frames 1s ease-in-out 0s 1 normal forwards;
    opacity: 0;
  }
`;
...
const ContactUsRight = styled.div`
  ...
  &.animate-enter27 {
    animation: animate-enter27-frames 0.2s ease-in-out 0.6s 1 normal forwards;
    opacity: 0;
  }
`;
...
const ContactUsHeader = styled.div`
  ...
  &.animate-enter28 {
    animation: animate-enter28-frames 0.4s ease-in-out 0s 1 normal forwards;
    opacity: 0;
  }
`;
...
export default LandingPageXSV22;
