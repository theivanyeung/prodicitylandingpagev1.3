...
function ContactUsFormEmailInput3(props) {
  const { inputType, inputPlaceholder, className } = props;

  return (
    <ContactUsFormEmailInput className={`contact-us-form-email-input-3 ${className || ""}`}>
      <EmailInputPlaceholderText
        className="email-input-placeholder-text-6"
...
const ContactUsFormEmailInput = styled.div`
  ...
  &.contact-us-form-email-input-3.contact-us-form-subject-input-3 {
    height: 44px;
    margin-top: 10px;
  }
`;
...
export default ContactUsFormEmailInput3;
